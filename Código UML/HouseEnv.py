...
class HouseEnv(AbstractHouseEnv, Enviroment):
	...
	def areAdjacent(self, aSelf, aObject1 = str, aObject2 = str, aPosition1 = List[int], aPosition2 = List[int]) -> long:
	...
	def transferDrugs(self, aSelf, aMover = str, aGiver = str, aReciever = str, aQuantity = int) -> long:
