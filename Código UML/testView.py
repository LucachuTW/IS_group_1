...
class testView(object):
    def test_createsViewer(self, aSelf):
    ...
    def test_drawCabinet(self, aSelf):
    ...
    def test_existsEmptyBox(self, aSelf):
    ...
    def test_existsWall(self, aSelf):
    ...
    def test_existsDoor(self, aSelf):
    ...
    def test_existsCabinet(self, aSelf):
    ...
    def test_existsOwner(self, aSelf):
    ...
    def test_existsRobot(self, aSelf):
